...
var propsTransformer = {
    ...
    insert: function (input, newValues) {
        ...
        var generatedIndex = input.indexOf(propsTransformer.AUTOGENERATED_TAG);
        if (generatedIndex >= 0) {
            input = input.substr(0, generatedIndex);
        }

        var output = input + EOL + propsTransformer.AUTOGENERATED_TAG + EOL + newValues;
...
module.exports = {'ios': iOSTransformer, 'android': androidTransformer, 'json': jsonTransformer, 'dart': dartTransformer, 'dartTemplate': dartTemplateTransformer, '.net': dotNetTransformer, 'props': propsTransformer };
